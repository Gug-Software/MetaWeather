...
class CommonErrorView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr) {

    private val binding: CommonErrorViewBinding =
        CommonErrorViewBinding.inflate(LayoutInflater.from(context), this, true)
